...
public class MainActivity extends AppCompatActivity {
    ...
    private void initChooseDialog(){
        choose_dialog = new AlertDialog.Builder(seft).setTitle("选择城市").setPositiveButton("确定",new ChooseCityListenner())
        ...
        city_spinner = (Spinner) choose_layout.findViewById(R.id.city_sprinner);
